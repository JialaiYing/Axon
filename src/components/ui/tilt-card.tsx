...
export function TiltCard({ children, className, maxTilt = 8, glow = true }: TiltCardProps) {
  ...
  const glowBackground = useMotionTemplate`radial-gradient(220px circle at ${glowXPercent} ${glowYPercent}, color-mix(in srgb, var(--color-accent) 16%, transparent), transparent 65%)`;
