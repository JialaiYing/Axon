  ...
  return (
    <TabsPrimitive.Trigger
      className={cn(
        ...
        "data-[state=active]:bg-accent data-[state=active]:text-accent-foreground data-[state=active]:shadow-[0_0_0_1px_rgba(94,106,210,0.15),0_4px_16px_-6px_rgba(94,106,210,0.5)] light:data-[state=active]:shadow-[0_1px_2px_rgba(23,24,28,0.15)]",
