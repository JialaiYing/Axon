        ...
        <ScrollRevealGroup className="mx-auto grid max-w-4xl grid-cols-1 gap-x-8 gap-y-4 sm:grid-cols-2">
          {BENEFITS.map((benefit) => (
            <ScrollRevealItem key={benefit}>
              <TiltCard maxTilt={4}>
                <div className="flex items-start gap-3 rounded-lg border border-border bg-card p-4 transition-[box-shadow,border-color,background-color] duration-300 hover:border-border-strong hover:bg-card-hover hover:shadow-[0_16px_40px_-18px_rgba(0,0,0,0.6)]">
