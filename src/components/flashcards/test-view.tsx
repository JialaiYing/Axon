        ...
        {phase === "running" && question && (
          ...
          >
            ...
            {question.type === "trueFalse" && (
              <>
                <div className="w-full max-w-md rounded-md border border-border/60 bg-card p-4 text-center text-sm font-medium text-foreground shadow-none light:border-border">
