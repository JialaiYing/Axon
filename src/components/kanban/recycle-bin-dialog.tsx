    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[80vh] max-w-lg overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Finished objectives you sent here, or that aged out automatically. Anything
            left here is permanently deleted after 30 days.
          </DialogDescription>
        </DialogHeader>
              ...
              return (
                ...
                >
                  <button
                    ...
                    className="flex w-full items-center justify-between gap-3 px-3.5 py-3 text-left transition-colors hover:bg-card"
                  >
                    ...
                    <Badge variant={priorityBadgeVariant(objective.priority)} className="capitalize shrink-0">
                      {objective.priority}
                    </Badge>
                  </button>
